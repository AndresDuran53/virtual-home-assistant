...
class PeopleManager():
    ...
    def __init__(self, people_list: list[Person] = []):
        self.set_people_list(people_list)

    def set_people_list(self, people_list: list[Person]):
    ...
    def already_home_to_text(self) -> str:
        if len(self.people_list) == 0:
            return ""
